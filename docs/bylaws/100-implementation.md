---
description: "Регламент реализации изменений PHP-FIG 3.0: переходные положения при принятии нового устава, сроки и порядок признания участников и формирования основного комитета."
---
