---
description: "Русский перевод рекомендаций по стандартам PHP (PSR) от группы PHP-FIG. Полный индекс принятых, черновых и устаревших стандартов."
---
...
[psr8]: proposed/psr-8-hug/psr-8-hug.md
[psr9]: proposed/security-reporting-process.md
[psr10]: proposed/security-disclosure-publication.md
