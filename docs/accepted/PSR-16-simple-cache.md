---
description: "PSR-16 — простой интерфейс кэширования PHP. Описывает упрощённый интерфейс для элемента кэша и драйвера кэша в отличие от более сложного PSR-6."
---
