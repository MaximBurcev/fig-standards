---
description: "Кэширование — распространённый способ повысить производительность любого проекта. Мета-документ PSR-6 описывает обоснование стандарта интерфейса кэширования."
---
