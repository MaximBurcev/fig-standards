---
description: "PSR-11 — стандарт интерфейса контейнера внедрения зависимостей PHP. Описывает ContainerInterface для стандартизации получения объектов и параметров из DI-контейнеров."
---
