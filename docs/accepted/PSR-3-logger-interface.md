---
description: "PSR-3 — стандарт общего интерфейса логирования PHP. Описывает интерфейс LoggerInterface для унифицированной записи логов в библиотеках и фреймворках."
---
