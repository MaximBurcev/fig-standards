---
description: "PSR-7 — стандарт интерфейсов HTTP-сообщений PHP. Описывает общие интерфейсы для представления HTTP-запросов и ответов согласно RFC 7230 и RFC 7231."
---
