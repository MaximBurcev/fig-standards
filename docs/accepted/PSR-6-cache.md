---
description: "PSR-6 — стандарт общего интерфейса кэширования PHP. Определяет единый интерфейс для библиотек кэширования, позволяющий избежать зависимости от конкретных реализаций."
---
