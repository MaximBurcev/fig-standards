---
description: "PSR-15 — стандарт обработчиков HTTP-запросов PHP. Описывает интерфейсы для серверных обработчиков запросов и HTTP middleware, использующих PSR-7 HTTP-сообщения."
---
