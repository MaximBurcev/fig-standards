---
description: "Расширенное руководство по стилю кодирования PSR-12 дополняет и заменяет PSR-2, описывая правила форматирования PHP-кода с учётом возможностей современных версий языка."
---
