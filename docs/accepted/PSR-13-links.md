---
description: "PSR-13 — стандарт интерфейсов гипермедийных ссылок PHP. Определяет простой и универсальный способ представления гипермедиа-ссылок независимо от формата сериализации."
---
