---
description: "PSR-17 — стандарт HTTP-фабрик PHP. Описывает общий стандарт для фабрик, создающих HTTP-объекты, совместимые с PSR-7, без привязки к конкретной реализации."
---
