---
description: "Целью данного PSR является предоставление фабричных интерфейсов, которые определяют методы создания объектов PSR-7. Мета-документ HTTP-фабрик."
---
