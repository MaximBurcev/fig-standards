---
description: "PSR-18 — стандарт HTTP-клиента PHP. Описывает общий интерфейс для отправки HTTP-запросов и получения HTTP-ответов, обеспечивающий совместимость между библиотеками."
---
