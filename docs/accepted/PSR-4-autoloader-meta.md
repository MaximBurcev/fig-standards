---
description: "Цель PSR-4 — указать правила для интероперабельного автозагрузчика PHP, сопоставляющего пространства имён с путями файловой системы. Мета-документ."
---
