---
description: "Цель руководства по стилю кодирования PSR-2 — уменьшить когнитивные трения при чтении кода разных авторов путём единого набора правил форматирования PHP."
---
