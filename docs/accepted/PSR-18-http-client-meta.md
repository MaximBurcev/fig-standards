---
description: "HTTP-запросы и ответы — два фундаментальных объекта веб-программирования. Мета-документ описывает обоснование PSR-18 для общего интерфейса HTTP-клиента."
---
