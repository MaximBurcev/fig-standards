---
description: "PSR-14 — стандарт диспетчера событий PHP. Устанавливает общий механизм расширения и взаимодействия на основе событий для повторного использования библиотек в разных фреймворках."
---
