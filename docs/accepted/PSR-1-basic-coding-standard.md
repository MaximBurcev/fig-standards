---
description: "PSR-1 — основной стандарт кодирования PHP. Определяет базовые требования к коду для обеспечения высокого уровня технического взаимодействия между PHP-проектами."
---
