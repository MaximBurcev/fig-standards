---
description: "PSR-8 — нереализованный стандарт «взаимных объятий» PHP-FIG. Юмористическое предложение по интерфейсу Huggable для PHP-объектов, поддерживающих объятия."
---
