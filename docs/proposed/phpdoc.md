---
description: "PSR-5 предоставляет полное и формальное определение стандарта PHPDoc для документирования PHP-кода: формат блоков, теги, типы и основные принципы."
---
