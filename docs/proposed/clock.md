---
description: "PSR-20 — черновой стандарт интерфейса часов PHP. Описывает простой интерфейс ClockInterface для чтения системного времени, обеспечивающий тестируемость кода."
---
